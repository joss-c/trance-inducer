...
function drawSquare(canvas, context) {
	...
	// COLOUR SCHEMES
	var colourScheme1 = JSON.stringify("rgb("+lfo_1[arrayIndex]+", "+lfo_1[arrayIndex+rndNum(50,100)]+", "+lfo_2[arrayIndex+rndNum(0,13)]+")");
	var colourScheme2 = JSON.stringify("rgb("+lfo_2[arrayIndex]+", "+lfo_1[arrayIndex+rndNum(0,100)]+", "+lfo_1[arrayIndex]+")");
	var colourScheme3 = JSON.stringify("rgb("+lfo_1[arrayIndex+rndNum(0,3)]+", "+lfo_1[arrayIndex+rndNum(0,5)]+", "+lfo_2_saw[arrayIndex]+")");
	var colourScheme4 = JSON.stringify("rgb("+lfo_1[arrayIndex+rndNum(0,3)]+", "+lfo_2_saw_reversed[arrayIndex+rndNum(3,10)]+", "+lfo_2_saw[arrayIndex]+")");

	var w = (squareSize == "3" ? lfo_3_3 : squareSize == "5" ? lfo_3_5 : squareSize == "10" ? lfo_3_10 : squareSize == "20" ? lfo_3_20 : squareSize == "35" ? lfo_3_35 : squareSize == "60" ? lfo_3_60 : lfo_3_1)[arrayIndex];
	var x = rndNum((gradient == "enabled" ? rndNum(0, canvas.width) : 0),canvas.width);
	var y = Math.floor(Math.random() * canvas.height);
	
	context.fillStyle = JSON.parse((colourScheme == "1" ? colourScheme1 : colourScheme == "2" ? colourScheme2 : colourScheme == "3" ? colourScheme3 : colourScheme4));
